...
import ImgBullet from './images/bullet_points_with_summary.svg';
import ImgRefine from './images/refine_my_words.svg';
  ...
  return (
    ...
    >
      <header className="flex flex-col gap-4">
        <Heading as={'h4'}>
          And yes, it can fit any purpose, no matter what you&apos;re up to
        </Heading>

        <SubHeading>
          Audea understands that your individual needs can vary from time to
          time.
        </SubHeading>
      </header>
