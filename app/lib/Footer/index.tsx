...
import Mangggo from './Mangggo';

export default function Footer() {
  const navigations = navigationItem.concat([
    {
      name: 'Privacy Policy',
      url: 'https://audeaid.notion.site/Privacy-Policy-f865747ed0e142fa92680408d91fe136?pvs=4',
    },

    {
      name: 'Terms of Service',
      url: 'https://audeaid.notion.site/Terms-of-Service-d0dcba2ccba54a9bb60b6c1dc0255c4f?pvs=4',
    },

    {
      name: 'Pricing Manifesto',
      url: 'https://audeaid.notion.site/Pricing-Manifesto-775142d7ebf34bb184915a16dfd8dd5b?pvs=4',
    },
  ]);
